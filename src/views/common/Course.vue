<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="queryList.keyWord" placeholder="课程名称" clearable style="width: 200px;margin-right: 15px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-select v-model="queryList.majorId" clearable style="width: 200px;margin-right: 15px;" class="filter-item" placeholder="请选择">
        <el-option
    ...
    <pagination v-show="total>0" :total="total" :page.sync="queryList.page" :limit.sync="queryList.pageSize" @pagination="getCourses()" />
...
<script>
/* eslint-disable */
  import {getCourses, insertCourse,updateMajor,deleteMajor} from '@/api/course'
  ...
  export default {
    ...
    methods: {
      ...
      async insertCourse(){
        const course = {majorId:this.dataForm.majorId,

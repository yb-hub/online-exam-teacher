<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="随机组卷" style="margin-bottom: 20px">
      <el-form ref="dataForm" :rules="rules" :model="tempPaper" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="所属科目" prop="courseId">
          <el-select v-model="tempPaper.courseId" placeholder="选择科目" clearable style="width: 200px;margin-right: 15px;" class="filter-item">
        ...
        <el-form-item label="考试类型" prop="type">
          <el-select v-model="tempPaper.type" placeholder="选择考试类型" clearable style="width: 200px;margin-right: 15px;" class="filter-item">
        ...
        <el-form-item label="题目总数" prop="totalQuestion">
          <el-input v-model="tempPaper.totalQuestion" :readonly="true" :min="0" :max="200" style="width: 200px;margin-right: 15px;"/>
        </el-form-item>
        <el-form-item label="试卷总分" prop="totalScore">
          <el-input v-model="tempPaper.totalScore" :readonly="true" :min="0" :max="200" style="width: 200px;margin-right: 15px;"/>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
<script>
  ...
  import {insertPaper} from '@/api/paper'
  export default {
    name: 'Paper',
